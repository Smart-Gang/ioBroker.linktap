...
class LinkTapTapLinker {
  ...
  activateInstantMode(action, duration, autoBack) {    
    ...
    fetch(this.urlActivateInstantMode, {
      ...
      .then((res) => {
        this.logger.info("Sent instant mode command. Status: " + res.status);
        return res.json();
      })
      .then((json) => {
        if (json.result == "ok") {
  ...
  activateIntervalMode() {    
    ...
    fetch(this.urlActivateIntervalMode, {
      ...
      .then((res) => {
        this.logger.info("Sent interval mode command. Status: " + res.status);
        return res.json();
      })
      .then((json) => {
        if (json.result == "ok") {
  ...
  activateSevenDayMode(action, duration, autoBack) {    
    ...
    fetch(this.urlActivateSevenDayMode, {
      ...
      .then((res) => {
        this.logger.info("Sent seven day mode command. Status: " + res.status);
        return res.json();
      })
      .then((json) => {
        if (json.result == "ok") {
  ...
  activateMonthMode(action, duration, autoBack) {    
    ...
    fetch(this.urlActivateMonthMode, {
      ...
      .then((res) => {
        this.logger.info("Sent month mode command. Status: " + res.status);
        return res.json();
      })
      .then((json) => {
        if (json.result == "ok") {
